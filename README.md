#### PLEASE DON'T USE ESPRESSO, ISN'T READY TO BE USED AND UNDER DEVELOPMENT
<br><sup>Espresso the Sulake's Retro Housekeeping</sup></p>

<p><a href="/sant0ro/espresso/blob/master"><img src="https://camo.githubusercontent.com/b0224997019dec4e51d692c722ea9bee2818c837/68747470733a2f2f696d672e736869656c64732e696f2f6769746875622f6c6963656e73652f6d6173686170652f6170697374617475732e737667" alt="license" data-canonical-src="https://img.shields.io/github/license/mashape/apistatus.svg" style="max-width:100%;"></a></p>
...
<p><strong>Espresso</strong> it's an open source content management system backend to manage the Habbo.com Clone'CMS "<strong>Chocolatey</strong>".</p>
...
<p>Espresso was created to ensure that you have a fully and enjoiable experience with <strong>Chocolatey</strong>. Espresso allows you to manage the entire retro environment with advanced features.</p>

<h4><a id="user-content-how-i-can-have-a-full-experience-with-espreso" class="anchor" href="#how-i-can-have-a-full-experience-with-espreso" aria-hidden="true"><svg aria-hidden="true" class="octicon octicon-link" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>How I can have a full experience with Espresso?</h4>

<ul>
<li><strong>Espresso</strong> uses the Arcturus Emulator Database Schema, like <strong>Chocolatey</strong>. In order to use <strong>Espresso</strong> you need download <a href="http://arcturus.wf">Arcturus</a></li>
...
<li>To get Photo &amp; Selfies Features in both <strong>Espresso</strong> &amp; <strong>Chocolatey</strong> you need do a donation to the Open Source Project <a href="http://arcturus.wf">Arcturus</a>. It's totally optional. But it's an awesome show stopper feature.</li>
</ul>
...
<h4><a id="user-content-installing-a-production-version-of-espreso-is-really-easy" class="anchor" href="#installing-a-production-version-of-espreso-is-really-easy" aria-hidden="true"><svg aria-hidden="true" class="octicon octicon-link" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Installing a Production version of Espresso is really easy</h4>

<ol>
<li>Download the latest <strong>Espresso</strong> release</li>
...
<li>To finally migrate the Espresso Database. Open your <i>Terminal/CMD/Console</i> on the Espresso folder And execute the following command.: <code>php artisan migrate</code>. <strong>If all Database credentials are right, Espresso</strong> will successfully deploy his Database.</li>
